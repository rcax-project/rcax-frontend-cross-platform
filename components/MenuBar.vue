...
<style>
.menubar {
  @apply sticky top-[56px] lg:top-[56px] z-30 w-full bg-gradient-to-r from-[#141415]/95 via-[#1a1a1b]/95 to-[#141415]/95 backdrop-blur-xl border-b border-zinc-800/50 shadow-sm duration-500;
}
